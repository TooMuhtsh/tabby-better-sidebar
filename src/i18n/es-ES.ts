...
const es_ES: Record<string, string> = {
    ...
    'Could not download {path}': 'No se pudo descargar {path}',
    '{name} opened — every save will be sent back to the server': '{name} abierto — cada guardado se enviará al servidor',
    '{name} has changed on the server, and your local copy has unsaved changes. Taking the server version will lose those local changes.': '{name} ha cambiado en el servidor y su copia local tiene cambios sin guardar. Tomar la versión del servidor hará perder esos cambios locales.',
    'Take the server version': 'Tomar la del servidor',
    'Could not refresh {name} from the server': 'No se pudo actualizar {name} desde el servidor',
    '{name} was refreshed from the server': '{name} se actualizó desde el servidor',
    '{name} has changed on the server since it was opened. Saving will overwrite those remote changes. Continue?': '{name} ha cambiado en el servidor desde que se abrió. Guardar sobrescribirá esos cambios remotos. ¿Continuar?',
    '{name} was not sent back — the remote file is untouched': '{name} no se reenvió — el archivo remoto está intacto',
    '{name} sent back to the server': '{name} reenviado al servidor',
    'Could not send {name} back': 'No se pudo reenviar {name}',
    'Dragging out to the OS is not available on this installation': 'Arrastrar fuera al sistema no está disponible en esta instalación',
    'Could not start the drag': 'No se pudo iniciar el arrastre',
    'Could not prepare {name} for dragging': 'No se pudo preparar {name} para arrastrar',
    '{name} is ready — drag it again to drop it': '{name} está listo — arrástrelo de nuevo para soltarlo',
    '{name} has changed on the server — drag it again to get the current version': '{name} ha cambiado en el servidor — arrástrelo de nuevo para obtener la versión actual',
    '{name} was sent back, but its permissions could not be restored ({mode})': '{name} se reenvió, pero no se pudieron restablecer sus permisos ({mode})',
    '{name}: drop folder not found, delivered to {folder}': '{name}: carpeta de destino no encontrada, entregado en {folder}',
    '{name} dropped in {folder}': '{name} soltado en {folder}',
    '{name} could not be dropped in {folder}': '{name} no se pudo soltar en {folder}',
    'Choose the editor for remote files': 'Elegir el editor de archivos remotos',
    'Use this editor': 'Usar este editor',
    'All files': 'Todos los archivos',
    'Applications': 'Aplicaciones',
    'No file picker is available to choose an editor': 'No hay ningún selector de archivos disponible para elegir un editor',
    'editor': 'editor',
    'Could not read the shortcut {path}': 'No se pudo leer el acceso directo {path}',
    'Could not launch the editor {path}': 'No se pudo iniciar el editor {path}',
    'Could not open the "Open with" dialog': 'No se pudo abrir el cuadro «Abrir con»',
    'Editor remembered: {path} — change it in Settings → Better Sidebar': 'Editor recordado: {path} — se puede cambiar en Ajustes → Better Sidebar',
    'tabby-better-sidebar cannot start on this version of Tabby — see the console for details': 'tabby-better-sidebar no puede iniciarse en esta versión de Tabby — vea la consola para más detalles',
    'tabby-better-sidebar: {lost} — unavailable on this version of Tabby': 'tabby-better-sidebar: {lost} — no disponible en esta versión de Tabby',
    'the sidebar itself': 'la propia barra lateral',
    'active sessions, SFTP and tunnels': 'las sesiones activas, SFTP y los túneles',
    'the SFTP panel': 'el panel SFTP',
    ...
    'folder': 'carpeta',
    'profile': 'perfil',
    'snippet default': 'valor por defecto del snippet',
    'preparing...': 'preparando...',
    'The download of {name} could not start': 'La descarga de {name} no pudo iniciarse',
    'no file at destination ({path})': 'ningún archivo en el destino ({path})',
    '{actual} bytes at destination, {expected} expected': '{actual} bytes en el destino, se esperaban {expected}',
    '{name}: arrival not verified — {reason}': '{name}: llegada no verificada — {reason}',
    'The upload of {name} could not start': 'La subida de {name} no pudo iniciarse',
