...
const fr_FR: Record<string, string> = {
    ...
    'Could not download {path}': 'Impossible de télécharger {path}',
    '{name} opened — every save will be sent back to the server': '{name} ouvert — chaque enregistrement sera renvoyé au serveur',
    '{name} has changed on the server, and your local copy has unsaved changes. Taking the server version will lose those local changes.': '{name} a changé sur le serveur, et votre copie locale a des modifications non enregistrées. Reprendre la version du serveur fera perdre ces modifications locales.',
    'Take the server version': 'Reprendre celle du serveur',
    'Could not refresh {name} from the server': 'Impossible d\'actualiser {name} depuis le serveur',
    '{name} was refreshed from the server': '{name} a été actualisé depuis le serveur',
    '{name} has changed on the server since it was opened. Saving will overwrite those remote changes. Continue?': '{name} a changé sur le serveur depuis son ouverture. Enregistrer écrasera ces modifications distantes. Continuer ?',
    '{name} was not sent back — the remote file is untouched': '{name} n\'a pas été renvoyé — le fichier distant est intact',
    '{name} sent back to the server': '{name} renvoyé sur le serveur',
    'Could not send {name} back': 'Échec du renvoi de {name}',
    'Dragging out to the OS is not available on this installation': 'Le glisser-déposer sortant n\'est pas disponible sur cette installation',
    'Could not start the drag': 'Impossible de démarrer le glisser-déposer',
    'Could not prepare {name} for dragging': 'Impossible de préparer {name} pour le glisser-déposer',
    '{name} is ready — drag it again to drop it': '{name} est prêt — glissez-le à nouveau pour le déposer',
    '{name} has changed on the server — drag it again to get the current version': '{name} a changé sur le serveur — reglissez-le pour obtenir la version à jour',
    '{name} was sent back, but its permissions could not be restored ({mode})': '{name} a été renvoyé, mais ses permissions n\'ont pas pu être rétablies ({mode})',
    '{name}: drop folder not found, delivered to {folder}': '{name} : dossier de dépôt introuvable, livré dans {folder}',
    '{name} dropped in {folder}': '{name} déposé dans {folder}',
    '{name} could not be dropped in {folder}': '{name} n\'a pas pu être déposé dans {folder}',
    'Choose the editor for remote files': 'Choisir l\'éditeur des fichiers distants',
    'Use this editor': 'Utiliser cet éditeur',
    'All files': 'Tous les fichiers',
    'Applications': 'Applications',
    'No file picker is available to choose an editor': 'Aucun sélecteur de fichier disponible pour choisir un éditeur',
    'editor': 'éditeur',
    'Could not read the shortcut {path}': 'Impossible de lire le raccourci {path}',
    'Could not launch the editor {path}': 'Impossible de lancer l\'éditeur {path}',
    'Could not open the "Open with" dialog': 'Impossible d\'ouvrir la boîte « Ouvrir avec »',
    'Editor remembered: {path} — change it in Settings → Better Sidebar': 'Éditeur mémorisé : {path} — modifiable dans Paramètres → Better Sidebar',
    'tabby-better-sidebar cannot start on this version of Tabby — see the console for details': 'tabby-better-sidebar ne peut pas démarrer sur cette version de Tabby — voir la console pour le détail',
    'tabby-better-sidebar: {lost} — unavailable on this version of Tabby': 'tabby-better-sidebar : {lost} — indisponible sur cette version de Tabby',
    'the sidebar itself': 'la sidebar elle-même',
    'active sessions, SFTP and tunnels': 'les sessions actives, le SFTP et les tunnels',
    'the SFTP panel': 'le panneau SFTP',
    ...
    'folder': 'dossier',
    'profile': 'profil',
    'snippet default': 'défaut du snippet',
    'preparing...': 'préparation...',
    'The download of {name} could not start': 'Le téléchargement de {name} n\'a pas pu démarrer',
    'no file at destination ({path})': 'aucun fichier à destination ({path})',
    '{actual} bytes at destination, {expected} expected': '{actual} octets à destination, {expected} attendus',
    '{name}: arrival not verified — {reason}': '{name} : arrivée non vérifiée — {reason}',
    'The upload of {name} could not start': 'L\'envoi de {name} n\'a pas pu démarrer',
