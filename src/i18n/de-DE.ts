...
const de_DE: Record<string, string> = {
    ...
    // Toasts, dialogs and captions that used to be hard-coded in French —    // sftpRemoteEdit.ts, sftpDragOut.ts, transfers.ts, dragOutServer.service.ts,    // editorLauncher.service.ts, mount.service.ts / hostCompat.ts, hotkeys.ts,    // snippets.service.ts, sftpBrowser.component.pug (preparing marker).
    'Could not download {path}': '{path} konnte nicht heruntergeladen werden',
    '{name} opened — every save will be sent back to the server': '{name} geöffnet — jedes Speichern wird an den Server zurückgeschickt',
    '{name} has changed on the server, and your local copy has unsaved changes. Taking the server version will lose those local changes.': '{name} hat sich auf dem Server geändert, und Ihre lokale Kopie enthält ungespeicherte Änderungen. Die Serverversion zu übernehmen verwirft diese lokalen Änderungen.',
    'Take the server version': 'Serverversion übernehmen',
    'Could not refresh {name} from the server': '{name} konnte nicht vom Server aktualisiert werden',
    '{name} was refreshed from the server': '{name} wurde vom Server aktualisiert',
    '{name} has changed on the server since it was opened. Saving will overwrite those remote changes. Continue?': '{name} hat sich seit dem Öffnen auf dem Server geändert. Speichern überschreibt diese entfernten Änderungen. Fortfahren?',
    '{name} was not sent back — the remote file is untouched': '{name} wurde nicht zurückgeschickt — die entfernte Datei ist unverändert',
    '{name} sent back to the server': '{name} an den Server zurückgeschickt',
    'Could not send {name} back': '{name} konnte nicht zurückgeschickt werden',
    'Dragging out to the OS is not available on this installation': 'Das Herausziehen ins Betriebssystem ist in dieser Installation nicht verfügbar',
    'Could not start the drag': 'Der Ziehvorgang konnte nicht gestartet werden',
    'Could not prepare {name} for dragging': '{name} konnte nicht zum Ziehen vorbereitet werden',
    '{name} is ready — drag it again to drop it': '{name} ist bereit — erneut ziehen, um es abzulegen',
    '{name} has changed on the server — drag it again to get the current version': '{name} hat sich auf dem Server geändert — erneut ziehen, um die aktuelle Version zu erhalten',
    '{name} was sent back, but its permissions could not be restored ({mode})': '{name} wurde zurückgeschickt, aber seine Berechtigungen konnten nicht wiederhergestellt werden ({mode})',
    '{name}: drop folder not found, delivered to {folder}': '{name}: Zielordner nicht gefunden, abgelegt in {folder}',
    '{name} dropped in {folder}': '{name} abgelegt in {folder}',
    '{name} could not be dropped in {folder}': '{name} konnte nicht in {folder} abgelegt werden',
    'Choose the editor for remote files': 'Editor für entfernte Dateien wählen',
    'Use this editor': 'Diesen Editor verwenden',
    'All files': 'Alle Dateien',
    'Applications': 'Anwendungen',
    'No file picker is available to choose an editor': 'Kein Dateiauswahldialog verfügbar, um einen Editor zu wählen',
    'editor': 'Editor',
    'Could not read the shortcut {path}': 'Die Verknüpfung {path} konnte nicht gelesen werden',
    'Could not launch the editor {path}': 'Der Editor {path} konnte nicht gestartet werden',
    'Could not open the "Open with" dialog': 'Der Dialog „Öffnen mit“ konnte nicht geöffnet werden',
    'Editor remembered: {path} — change it in Settings → Better Sidebar': 'Editor gemerkt: {path} — änderbar unter Einstellungen → Better Sidebar',
    'tabby-better-sidebar cannot start on this version of Tabby — see the console for details': 'tabby-better-sidebar kann auf dieser Tabby-Version nicht starten — Details in der Konsole',
    'tabby-better-sidebar: {lost} — unavailable on this version of Tabby': 'tabby-better-sidebar: {lost} — auf dieser Tabby-Version nicht verfügbar',
    'the sidebar itself': 'die Sidebar selbst',
    'active sessions, SFTP and tunnels': 'aktive Sitzungen, SFTP und Tunnel',
    'the SFTP panel': 'das SFTP-Panel',
    ...
    'folder': 'Ordner',
    'profile': 'Profil',
    'snippet default': 'Standardwert des Snippets',
    'preparing...': 'wird vorbereitet...',
    'The download of {name} could not start': 'Der Download von {name} konnte nicht gestartet werden',
    'no file at destination ({path})': 'keine Datei am Ziel ({path})',
    '{actual} bytes at destination, {expected} expected': '{actual} Bytes am Ziel, {expected} erwartet',
    '{name}: arrival not verified — {reason}': '{name}: Ankunft nicht bestätigt — {reason}',
    'The upload of {name} could not start': 'Der Upload von {name} konnte nicht gestartet werden',
